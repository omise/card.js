(function() {
  ...
  OmiseCard = (function() {
    function OmiseCard(params) {
      ...
      this.buttons = [];
      this.iframeEvent = {};
      this.serverOrigin = "https://cdn.omise.co";
      this.directory = "/card-2.0";
      this._setParams();
    }
    ...
    OmiseCard.prototype._createIframe = function() {
      ...
      _elem.src = "" + this.serverOrigin + this.directory + "/index.html";
      _elem.style.width = "100%";
      _elem.style.height = "100%";
      _elem.style.border = "none";
    ...
    OmiseCard.prototype._popIframeData = function(params) {
      ...
      this.iframeEvent.postMessage(JSON.stringify(data), this.serverOrigin + this.directory);
    };
